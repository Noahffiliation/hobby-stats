...
export default function GamesPage() {
  ...
  const backlogLabel =
    totalBacklog !== null ? `Backlog (${totalBacklog})` : "Backlog";
  const playedLabel =
    totalPlayed !== null
      ? `Played / Reviews (${totalPlayed})`
      : "Played / Reviews";
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-6 py-8 flex flex-col items-center justify-center text-center">
        <header className="mb-6 text-center">
          ...
          <p className="mt-1 text-sm text-zinc-400">
            Tracked video game backlog and played history on Backloggd.
          </p>
        </header>

        <div
          role="tablist"
          className="flex justify-center gap-2 mb-6 border-b border-zinc-800 pb-3 w-full max-w-2xl"
        >
          <button
            type="button"
            role="tab"
        ...
        {loading && (
          <div
            ...
            className="w-full max-w-2xl py-12 text-center text-zinc-400 animate-pulse"
          >
            Loading games...
          </div>
        )}
        ...
        {error && (
          <div
            ...
            className="w-full max-w-2xl p-4 rounded-xl bg-red-950/40 border border-red-800/60 text-red-300 text-center text-sm"
          >
            {error}
          </div>
        )}
        ...
        {!loading &&
          ...
          activeTab === "backlog" &&
          (backlog.length === 0 ? (
            <p className="w-full max-w-2xl text-center py-8 text-zinc-500">
              No backlog games found.
            </p>
          ) : (
