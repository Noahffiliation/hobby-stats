...
export async function getWatchedShows(): Promise<number> {
  const response = await fetch("/api/trakt?endpoint=watched-shows", {
    method: "GET",
  });
  if (!response.ok) {
...
export async function getWatchlistMovies(): Promise<TraktWatchlistMovie[]> {
  const response = await fetch("/api/trakt?endpoint=watchlist-movies", {
    method: "GET",
  });
  if (!response.ok) {
...
export async function getWatchlistShows(): Promise<TraktWatchlistShow[]> {
  const response = await fetch("/api/trakt?endpoint=watchlist-shows", {
    method: "GET",
  });
  if (!response.ok) {
...
export async function getRecentMovies(): Promise<TraktRecentMovie[]> {
  const response = await fetch("/api/trakt?endpoint=recent-movies", {
    method: "GET",
  });
  if (!response.ok) {
...
export async function getRecentEpisodes(): Promise<TraktRecentEpisode[]> {
  const response = await fetch("/api/trakt?endpoint=recent-episodes", {
    method: "GET",
  });
  if (!response.ok) {
