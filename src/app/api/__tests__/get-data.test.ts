...
describe("API Utils (get-data)", () => {
  ...
  it("getTraktStats fetches data successfully", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith("/api/trakt?endpoint=stats", {
      method: "GET",
    });
  });
  ...
  it("getTraktStats throws error when fetch is not ok", async () => {
    mockErrorResponse();
    await expect(getTraktStats()).rejects.toThrow(
      "Failed to fetch Trakt stats",
    );
  });
  ...
  it("getWatchedShows fetches count successfully", async () => {
    ...
    expect(fetch).toHaveBeenCalledWith("/api/trakt?endpoint=watched-shows", {
      method: "GET",
    });
  });
  ...
  it("getWatchedShows throws error when fetch is not ok", async () => {
    mockErrorResponse();
    await expect(getWatchedShows()).rejects.toThrow(
      "Failed to fetch Trakt watched shows",
    );
  });
  ...
  it("getWatchlistMovies fetches data successfully", async () => {
    ...
    expect(result).toEqual(mockData);
    expect(fetch).toHaveBeenCalledWith("/api/trakt?endpoint=watchlist-movies", {
      method: "GET",
    });
  });
  ...
  it("getWatchlistMovies throws error when fetch is not ok", async () => {
    mockErrorResponse();
    await expect(getWatchlistMovies()).rejects.toThrow(
      "Failed to fetch Trakt movie watchlist",
    );
  });
  ...
  it("getWatchlistShows fetches data successfully", async () => {
    ...
    expect(result).toEqual(mockData);
    expect(fetch).toHaveBeenCalledWith("/api/trakt?endpoint=watchlist-shows", {
      method: "GET",
    });
  });
  ...
  it("getWatchlistShows throws error when fetch is not ok", async () => {
    mockErrorResponse();
    await expect(getWatchlistShows()).rejects.toThrow(
      "Failed to fetch Trakt show watchlist",
    );
  });

  it("getRecentMovies fetches data successfully", async () => {
    const mockData = [
      { id: 1, movie: { title: "Recent Movie 1" }, watched_at: "2026-08-14" },
    ];
    mockSuccessResponse(mockData);

    const result = await getRecentMovies();
    expect(result).toEqual(mockData);
    expect(fetch).toHaveBeenCalledWith("/api/trakt?endpoint=recent-movies", {
      method: "GET",
    });
  });
  ...
  it("getRecentMovies throws error when fetch is not ok", async () => {
    mockErrorResponse();
    await expect(getRecentMovies()).rejects.toThrow(
  ...
  it("getRecentEpisodes fetches data successfully", async () => {
    ...
    expect(result).toEqual(mockData);
    expect(fetch).toHaveBeenCalledWith("/api/trakt?endpoint=recent-episodes", {
      method: "GET",
    });
  });
  ...
  it("getRecentEpisodes throws error when fetch is not ok", async () => {
    mockErrorResponse();
    await expect(getRecentEpisodes()).rejects.toThrow(
  ...
  it("getBackloggdStats throws error when fetch is not ok", async () => {
    mockErrorResponse();
    await expect(getBackloggdStats()).rejects.toThrow(
      "Failed to fetch Backloggd stats",
    );
  });
  ...
  it("getMyAnimeListStats throws error when fetch is not ok", async () => {
    mockErrorResponse();
    await expect(getMyAnimeListStats()).rejects.toThrow(
      "Failed to fetch MyAnimeList stats",
    );
  });
  ...
  it("getMyDramaListStats throws error when fetch is not ok", async () => {
    mockErrorResponse();
    await expect(getMyDramaListStats()).rejects.toThrow(
      "Failed to fetch MyDramaList stats",
    );
  });

  it("getGamesList fetches data successfully", async () => {
    const mockData = {
      backlog: [{ title: "Game 1" }],
      played: [{ title: "Game 2" }],
    };
    mockSuccessResponse(mockData);
  ...
  it("getAnimeList fetches data successfully", async () => {
    const mockData = {
      planToWatch: [{ id: 1, title: "Anime 1" }],
      completed: [{ id: 2, title: "Anime 2" }],
    };
    mockSuccessResponse(mockData);
  ...
  it("getDramaList fetches data successfully", async () => {
    const mockData = {
      planToWatch: [{ title: "Drama 1" }],
      completed: [{ title: "Drama 2" }],
    };
    mockSuccessResponse(mockData);
